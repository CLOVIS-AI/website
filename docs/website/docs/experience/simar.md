...
SIMAR is deployed on the site of the island's two freight ports: the East Harbour, which receives containers by sea, and the Roland Garros Airport, which receives freight by air. 
With the island population nearing one million, it is not food self-sufficient and relies on imports from Europe, India and Australia.
